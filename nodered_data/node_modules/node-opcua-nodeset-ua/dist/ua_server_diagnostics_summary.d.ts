...
export interface UAServerDiagnosticsSummary_Base<T extends DTServerDiagnosticsSummary> extends UABaseDataVariable_Base<T, DataType.ExtensionObject> {
    ...
    currentSessionCount: UABaseDataVariable<UInt32, DataType.UInt32>;
    cumulatedSessionCount: UABaseDataVariable<UInt32, DataType.UInt32>;
    securityRejectedSessionCount: UABaseDataVariable<UInt32, DataType.UInt32>;
    rejectedSessionCount: UABaseDataVariable<UInt32, DataType.UInt32>;
    sessionTimeoutCount: UABaseDataVariable<UInt32, DataType.UInt32>;
    sessionAbortCount: UABaseDataVariable<UInt32, DataType.UInt32>;
    publishingIntervalCount: UABaseDataVariable<UInt32, DataType.UInt32>;
    currentSubscriptionCount: UABaseDataVariable<UInt32, DataType.UInt32>;
    cumulatedSubscriptionCount: UABaseDataVariable<UInt32, DataType.UInt32>;
