...
export interface UAExclusiveLimitStateMachineEx extends UAObject, Omit<UAExclusiveLimitStateMachine_Base, "currentState" | "lastTransition">, UAStateMachineHelper, UAStateMachineEx {
}
