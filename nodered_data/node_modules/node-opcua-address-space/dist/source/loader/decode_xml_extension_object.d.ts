...
export declare function decodeXmlExtensionObject(addressSpace: IAddressSpace, encodingNodeId: NodeId, xmlBody: string, translateNodeId: (nodeId: string) => NodeId): ExtensionObject | null;
