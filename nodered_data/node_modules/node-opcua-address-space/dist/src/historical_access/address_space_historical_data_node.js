...
exports.VariableHistorian = void 0;
    ...
    async push(newDataValue) {
        ...
        if (sourceTime.getTime() <= this.lastDate.getTime()) {
            if (!(sourceTime.getTime() === this.lastDate.getTime() && sourcePicoSeconds > this.lastDatePicoSeconds)) {
                warningLog(chalk_1.default.red("Warning date not increasing "), chalk_1.default.cyan("\n node: ", this.node.browseName.toString(), this.node.nodeId.toString()), "\n new value       = ", newDataValue.toString(), "\n last known date = ", this.lastDate, "\n last known picoSeconds = ", this.lastDatePicoSeconds, "\n lastValue = ", this._timeline[this._timeline.length - 1]?.toString());
