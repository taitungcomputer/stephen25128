...
exports.checkValueRankCompatibility = checkValueRankCompatibility;
function checkValueRankCompatibility(actualValueRank, baseTypeValueRank) {
    ...
    if (baseTypeValueRank === OneOrMoreDimensions) {
        if (actualValueRank === OneOrMoreDimensions || actualValueRank >= 1)
            return { result: true };
        return {
            result: false,
...
//# sourceMappingURL=check_value_rank_compatibility.js.map