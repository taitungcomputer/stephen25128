...
export declare class ClientSubscriptionImpl extends EventEmitter implements ClientSubscription {
    ...
    priority: number;
    get monitoredItems(): ClientMonitoredItemBaseMap;
    set monitoredItems(value: ClientMonitoredItemBaseMap);
    timeoutHint: number;
    ...
    private _remove;
    _removeMonitoredItem(clientHandle: ClientHandle): void;
