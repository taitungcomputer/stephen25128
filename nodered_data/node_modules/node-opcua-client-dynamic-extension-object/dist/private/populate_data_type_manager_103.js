...
async function _extractDataTypeDictionaryFromDefinition(session, dataTypeDictionaryNodeId, dataTypeManager) {
    (0, node_opcua_assert_1.assert)(dataTypeManager, "expecting a dataTypeManager");
    ...
    for (const { className, dataTypeNodeId, dataTypeDefinition, isAbstract } of dataTypeDefinitionsSorted) {
        promises2.push((async () => {
            ...
            try {
                ...
                dataTypeManager, isAbstract, cache);
                // istanbul ignore next
                if (doDebug) {
