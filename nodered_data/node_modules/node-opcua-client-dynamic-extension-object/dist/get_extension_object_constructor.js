...
async function getExtensionObjectConstructor(session, dataTypeNodeId) {
    const dataTypeManager = await (0, get_extra_data_type_manager_1.getExtraDataTypeManager)(session);
    ...
    await (0, populate_data_type_manager_104_1.readDataTypeDefinitionAndBuildType)(session, dataTypeNodeId, browseName.name, dataTypeManager, {});
