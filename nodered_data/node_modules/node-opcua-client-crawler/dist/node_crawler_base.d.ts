...
import { BrowseDescriptionLike, BrowseDirection, BrowseResult, DataValue, ErrorCallback, NodeIdLike, ReadValueIdOptions, ReferenceDescription } from "node-opcua-client";
...
export declare class NodeCrawlerBase extends EventEmitter implements NodeCrawlerEvents {
    static follow(crawler: NodeCrawlerBase, cacheNode: CacheNode, userData: UserData, referenceType?: string, browseDirection?: BrowseDirection): void;
