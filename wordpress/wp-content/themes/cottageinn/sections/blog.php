...
$ed_section         = get_theme_mod( 'ed_blog_section', true );
$blog_subtitle      = get_theme_mod( 'blog_subtitle', esc_html__( 'OUR BLOG', 'cottageinn' ) );
$blog_title         = get_theme_mod( 'blog_title', esc_html__( 'Our News And Blogs', 'cottageinn' ) );
$blog_content       = get_theme_mod( 'blog_content' );
$blog_btn_lbl       = get_theme_mod( 'blog_btn_lbl', esc_html__( 'Read More', 'cottageinn' ) );
