...
$sec_title      = get_theme_mod( 'footer_top_title', esc_html__( 'Book Through Your Preferred Platform', 'cottageinn' ) );
                ...
                if( $footer_top ){
                    echo '<div class="booking-logo">';
                        foreach( $footer_top as $footer ){
                            ...
                            echo '<a href="' . esc_url( $footer_link ) . '" ' . esc_attr( $new_tab ) . '><img src=' . esc_url( wp_get_attachment_image_url( $footer_img, 'hotell-footer-top' ) ). '></a>';
                        }
                    echo '</div>';
                } ?>
            </div> 
